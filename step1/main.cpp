...
int main(int argc, char **argv)
{
  ...
  // Using AoS
  Particles* particles = (Particles*)malloc(sizeof(Particles) * N);
  Velocities* velocities = (Velocities*)malloc(sizeof(Velocities) * N);
  ...
  */
  MemDesc md(
                  &particles->pos_x,                7,                          0,            // Position in X
                  &particles->pos_y,                7,                          0,            // Position in Y
                  &particles->pos_z,                7,                          0,            // Position in Z
                  &particles->vel_x,                7,                          0,            // Velocity in X
                  &particles->vel_y,                7,                          0,            // Velocity in Y
                  &particles->vel_z,                7,                          0,            // Velocity in Z
                  &particles->weight,               7,                          0,            // Weight
  ...
  // 3. Copy data to GPU
  #pragma acc enter data copyin(particles[0:N], velocities[0:N])
  ...
  #pragma acc exit data copyout(particles[0:N], velocities[0:N])
